...
ggplotly(
  tooltip = c("x", "y", "group"),
  mti_by_user %>%
    ggplot(aes(x=assigned_user, y=MTI, fill=replace_na(assigned_user,"None"))) +
    geom_bar(stat="identity")
)
```

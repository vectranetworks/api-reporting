...
d_fields <- "id,first_timestamp,assigned_date,assigned_to,note_modified_timestamp,note_modified_by,note"
...
assigned_df <- select(d, id, fired, assigned_date, assigned_user)
